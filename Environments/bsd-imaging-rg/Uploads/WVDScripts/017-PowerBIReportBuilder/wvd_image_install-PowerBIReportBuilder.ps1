...
$SoftwareName = 'PowerBI Report Builder'
...
If ($aMSIs.Count -gt 0) {
    ...
    $Arguments = "/i `"$MSI`" /qn ACCEPT_EULA=1"
    ...
    $links = get-childitem -path "$env:SystemDrive\Users\Public\Desktop" -include 'PowerBI Report*.lnk'
    If ($links) {

...
.EXAMPLE
Confirm-HostPoolHealth -orchestrationFunctionsPath $currentDir -HostPoolName 'myhostPool' -HostPoolRGName 'hostPoolRg' -customImageReferenceId '/subscriptions/<subscriptionid>/resourceGroups/bsd-imaging-rg/providers/Microsoft.Compute/galleries/CustomerNameSharedImages/images/WIN10-20H2-DISPATCHER/versions/0.24322.55884'
